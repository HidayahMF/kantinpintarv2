...
const Dashboard = () => {
  ...
  const formatUSD = (num) => formatIDR(num);

  const stats = [
    { title: "Total Users", value: users.length },
    { title: "Total Orders", value: allOrders.filter(o=>o.paymentStatus==="completed").length },
    { title: "Total Revenue (this month)", value: monthlyRevenue.length ? formatIDR(monthlyRevenue[monthlyRevenue.length-1].total) : "Rp 0" },
  ];
        ...
        <div className="dashboard-chart-box">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <LineChart data={dailyRevenue} margin={{top:20,right:20,left:60,bottom:5}}>
              ...
              <XAxis dataKey="date"/>
              <YAxis width={75} tickFormatter={formatIDR}/>
